...
const Footer = () => {
  ...
  const handleMessageReceived = useCallback(({ name, profilePic, message }) => {
    console.log("in handleMessageReceived", name, profilePic);
  ...
  return (
    <div className="pt-20 lg:pt-24 bg-black">
      <Outlet />
      <section className="footer bg-black pt-10">
        <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center mt-8 space-x-6">
            ...
            <Link
              to={"http://www.linkedin.com/in/mohammed-amjad-ali-mk-brototype"}
            ...
            <Link
              to={"https://www.youtube.com/channel/UC5bqVr7s0fuCqRozqohw-aA"}
              className="cursor-pointer text-gray-400 hover:text-gray-500"
            >
