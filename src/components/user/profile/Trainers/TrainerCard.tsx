...
const TrainerCard = ({ trainer }) => {
  ...
  const differenceDays = dayjs(trainer.expiryDate).diff(dayjs(), "day");
      ...
      <>
        ...
        <div className="p-2 text-start sm:col-span-8 bg-black">
          <div className="flex justify-between mb-2">
            ...
            <p className="float-right uppercase text-red-500">
              {differenceDays == 0 ? "Today" : `${differenceDays} days left`}
            </p>
          </div>
          ...
          <span>
            ...
            <button
              onClick={() =>
                navigate(`/chat/${trainer.userId}/${trainer.trainerId._id}`)
              }
              className="lg:float-right outline-dotted outline-1 outline-white p-2 rounded-md hover:outline-green-500 hover:text-green-500"
            >
              Contact Trainer
            </button>
          </span>
